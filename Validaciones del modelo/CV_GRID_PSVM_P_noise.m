...
for dset = 1:size(datasets,1)
    ...
    for kerneltype = kerneltypes
        ...
        file1 = sprintf("Data_PSVM_P_noise\\ACCUMATRIX_%s_%s.mat",kerneltype, dataset_name);
        file2 = sprintf("Data_PSVM_P_noise\\AUCMATRIX_%s_%s.mat",kerneltype, dataset_name);
