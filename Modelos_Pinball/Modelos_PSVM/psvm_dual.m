function [w, b, prob, pred] = psvm_dual(X, y, kerneltype, C, epsilon,d,sigma,tau,X_test)
% PSVM dual vía CVX
% INPUTS:
...
cvx_begin quiet
variables alfa(m) beta_var(m) mu_var(m) gamma_var(m)
dual variable b
% Objetivo
maximize( ...
